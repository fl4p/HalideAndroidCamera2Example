...
#include "hl-pipelines/edge_detect.h"
...
JNIEXPORT bool JNICALL Java_com_example_halideandroidcamera2gl_HalideFilters_copyHalide(
...
JNIEXPORT bool JNICALL Java_com_example_halideandroidcamera2gl_HalideFilters_edgeDetectHalide(
    JNIEnv *env, jobject obj, jlong srcYuvBufferTHandle, jlong dstYuvBufferTHandle) {
    if (srcYuvBufferTHandle == 0L || dstYuvBufferTHandle == 0L ) {
