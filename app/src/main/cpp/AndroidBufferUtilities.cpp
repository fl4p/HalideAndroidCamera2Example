...
JNIEXPORT
jlong JNICALL Java_com_example_halideandroidcamera2gl_AndroidBufferUtilities_allocNativeYuvBufferT(
...
JNIEXPORT jboolean JNICALL Java_com_example_halideandroidcamera2gl_AndroidBufferUtilities_freeNativeYuvBufferT(
...
JNIEXPORT
jboolean JNICALL Java_com_example_halideandroidcamera2gl_AndroidBufferUtilities_rotateNativeYuvBufferT180(
    JNIEnv *env, jobject obj, jlong handle) {
    if (handle == 0L) {
        return false;
    }
...
JNIEXPORT jlong JNICALL Java_com_example_halideandroidcamera2gl_AndroidBufferUtilities_lockSurface(
    JNIEnv *env, jobject obj, jobject surface) {
    return reinterpret_cast<jlong>(LockedSurface::lock(env, surface));
}

JNIEXPORT jlong JNICALL Java_com_example_halideandroidcamera2gl_AndroidBufferUtilities_allocNativeYuvBufferTFromSurfaceHandle(
...
JNIEXPORT jboolean JNICALL Java_com_example_halideandroidcamera2gl_AndroidBufferUtilities_unlockSurface(
    JNIEnv *env, jobject obj, jlong lockedSurfaceHandle) {
    if (lockedSurfaceHandle == 0L) {
        return false;
    }
